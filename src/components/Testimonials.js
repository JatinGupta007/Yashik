  ...
  return (
    <section className="py-12 md:py-16 px-6 md:px-10 lg:px-16 mb-10 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <h1
          data-aos="fade-down"
          className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-center text-gray-900 mb-10 leading-tight px-4 capitalize"
        >
        ...
        <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="bg-[#155DFC]/10 rounded-xl p-6 md:p-9 transition-shadow relative pl-8 md:pl-12 md:w-116"
              data-aos="zoom-in"
            >
              <blockquote className="text-gray-700 text-lg md:text-xl leading-relaxed mb-12 md:w-86">
                &quot;{testimonial.quote}&quot;
              </blockquote>
