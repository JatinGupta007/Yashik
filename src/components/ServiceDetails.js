    ...
    <main className="overflow-hidden lg:overflow-visible">
      ...
      <section className="bg-linear-to-b from-white to-gray-50 py-12 md:py-20 px-4 md:px-8 lg:px-16 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="bg-white border text-[#155DFC] border-[#155DFC]/55 rounded-full px-6 md:px-8 py-2 md:py-3 shadow-sm">
      ...
      <section className="bg-white py-12 md:py-20 px-4 md:px-8 lg:px-16 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          {/* Badge */}
          <div data-aos="fade-left" className="mb-8 md:mb-10 flex items-center justify-center">
            <div className="inline-block bg-white border border-[#155DFC]/55 text-[#155DFC] rounded-full px-6 md:px-8 py-2 md:py-3 shadow-sm">
              <span className="text-xs md:text-sm uppercase font-medium tracking-wide">The Promise</span>
            </div>
          </div>
